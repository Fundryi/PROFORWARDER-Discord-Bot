...
client.on("clientReady", async () => {
  ...
  try {
    ...
    const registeredPortalCommand = typeof proforwarderCommand.toJSON === 'function'
      ? proforwarderCommand.toJSON()
      : proforwarderCommand;
    await client.application.commands.set([registeredPortalCommand]);
